...
int main(int argc, char* argv[])
{
    ...
    //the struct rusage has 2 structs: ru_utime(user time), which is actual computation AND ru_stime(kernel time), which is loading time and et al.... EG:  timeru_utime = { tv_sec = 0, tv_usec = 1000}, ru_stime = { tv_sec = 0, tv_usec = 1000}
